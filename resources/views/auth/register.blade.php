        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="date" id="birthdate" name="birthdate" value="{{ old('birthdate') }}" placeholder="YYYY-MM-DD" class="border sm:text-sm rounded-lg block w-full p-2.5 @error('birthdate') bg-red-50 border-red-700 text-red-900 placeholder-red-700 is-invalid @else bg-gray-50 border-gray-300 text-gray-900 @enderror" required>
                    @error('birthdate')
                        <div class="invalid-feedback text-red-700 pt-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </div>
